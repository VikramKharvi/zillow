...
2. Get rental price estimates for each listing and save to data/zillow_listings_with_rental.csv
"""
...
def main():
    ...
    if success2:
        ...
        if os.path.exists('data/zillow_listings_with_rental.csv'):
            print("  - data/zillow_listings_with_rental.csv (with rental estimates)")
        print(f"{'='*60}")
    else:
