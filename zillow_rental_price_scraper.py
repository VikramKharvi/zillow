...
def main():
    ...
    df_sorted.to_csv('data/zillow_listings_with_rental.csv', index=False)
    print("Updated data/zillow_listings_with_rental.csv with rental estimates, sorted by rent-to-price ratio (highest first).")
